...
p_load(sf,dplyr,ggthemes,plotly,leaflet,svglite,geojsonio,broom)
...
ggsave("output_men.svg", plot = menplot, device = "svg", width = 10, height = 8, units = "in")
