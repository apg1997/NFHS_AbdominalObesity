---
title: "Obesity amongst women, NFHS5"
...
```{r fitting model}
svyglm(obese_wtcircum ~ age_category+residence+education+religion+wealth+caste+meat, design=NFHS5_design, data = women, family = binomial()) %>% 
