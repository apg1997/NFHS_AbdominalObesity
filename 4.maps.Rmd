...
p_load(tidyverse, rio, janitor, here, geojsonio, ggmap, ggthemes, maptiles, MetBrewer, sf, tidyterra, svglite, sessioninfo)
```
...
color_palette <- c("<10" = "#41485f", "10-20" = "#5d6174", "20-30" = "#6e8291", "30-40" = "#f7c267", 
...
```{r session info}
sessioninfo::session_info(pkgs = c("loaded", "attached")[1], to_file = here("Session info","session_info_maps.txt"))
```