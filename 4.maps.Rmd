...
p_load(tidyverse, rio, janitor, here, geojsonio, ggmap, ggthemes, maptiles, MetBrewer, sf, tidyterra, svglite,ggpattern)
```
...
color_palette <- c("<10" = "#41485f", "10-20" = "#5d6174", "20-30" = "#b9b9b8", "30-40" = "#f7c267", 
...
district_womenplot_cat <- ggplot() + 
  geom_sf_pattern(data = underlay_map, aes(fill = "No Data"), pattern = 'stripe') +
  scale_fill_manual("", values = c("No Data" = "black"),
                     guide = guide_legend(override.aes = list(linetype = "solid", shape = NA))) +
...
# Create the plot with striped fill for the underlay map
district_womenplot_cat <- ggplot() + 
  geom_sf_pattern(data = underlay_map, aes(fill = "No Data"), pattern = 'stripe') +
  scale_fill_manual("", values = c("No Data" = "black"),
                     guide = guide_legend(override.aes = list(linetype = "solid", shape = NA))) +
