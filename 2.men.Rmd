...
men <- import_men %>% 
  ...
  mutate(smb305 = replace(smb305, smb305 %in% c(999.5,999.6), NA)) %>% 
...
transformations <- list(
  ...
  "Step 4 - Waist circumference recoding" = 
    function(data) {mutate(data, smb305 = replace(smb305, smb305 %in% c(999.5, 999.6), NA))},
  
  "Step 5 - Filtering NA in waist circumference" = 
    function(data) {filter(data, !is.na(smb305))},
...
export(men_state_wc_df,here("Output","men_state_obesity_prev_wc.xlsx"))
