...
pacman::p_load(tidyverse,lubridate,rio,janitor,here,gtsummary,survey,haven,labelled,sjlabelled,performance,jtools,forestploter,svglite)
```
...
ggplot2::ggsave(filename = here("Output", "fig_prev_plot2.svg"), plot = fig_prev_plot2,
                dpi = 300, width = 8.3, height = 14, units = "in")
```
