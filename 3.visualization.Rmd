...
fig_prev$"n[women]" <- ifelse(is.na(fig_prev$count_Obese_wc_women), "", fig_prev$count_Obese_wc_women)
fig_prev$"n[men]" <- ifelse(is.na(fig_prev$count_Obese_wc_men), "", fig_prev$count_Obese_wc_men)
...
fig_prev_plot <- forest(fig_prev[,c(1, 16, 18, 17, 19)],
            ...
            xlab = c(""),
            ticks_at = list(c(0, 0.25, 0.5, 1),c(0, 0.25, 0.5, 1)),
  ...
  edit_plot(row = c(1,2,6,9,14,25,31,38), which = "background",
